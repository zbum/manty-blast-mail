  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-slate-800">Report: {campaign.name}</h2>
        <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-green-50 rounded-lg p-4">
              <p className="text-xs font-medium text-slate-500 mb-1">Sent</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200">
        <div className="px-6 py-4 border-b border-slate-200">
          <h3 className="text-lg font-semibold text-slate-800">
            Send Logs {logsData ? `(${logsData.total.toLocaleString()})` : ''}
          </h3>
        </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-200">
                    ...
                    <th className="text-left px-6 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Sent At</th>
                  </tr>
                </thead>
            ...
            {totalPages > 1 && (
              <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-between">
                <p className="text-sm text-slate-500">
                  Page {logsData!.page} of {totalPages} ({logsData!.total.toLocaleString()} total)
                </p>
